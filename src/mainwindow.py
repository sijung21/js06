...
"")
        ...
        self.time_label_name.setGeometry(QtCore.QRect(1630, 570, 281, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.time_label_name.setText("")
        self.time_label_name.setAlignment(QtCore.Qt.AlignCenter)
        self.time_label_name.setObjectName("time_label_name")
        self.visibility_groupbox = QtWidgets.QGroupBox(self.centralwidget)
        self.visibility_groupbox.setGeometry(QtCore.QRect(1280, 620, 640, 201))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(24)
        font.setBold(True)
        font.setWeight(75)
        self.visibility_groupbox.setFont(font)
        self.visibility_groupbox.setStyleSheet("\n"
"")
        self.visibility_groupbox.setObjectName("visibility_groupbox")
        self.visibility_value = QtWidgets.QLabel(self.visibility_groupbox)
        self.visibility_value.setGeometry(QtCore.QRect(170, 50, 301, 111))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.pm25_groupbox = QtWidgets.QGroupBox(self.centralwidget)
        self.pm25_groupbox.setGeometry(QtCore.QRect(1280, 830, 640, 201))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(24)
        font.setBold(True)
        font.setWeight(75)
        self.pm25_groupbox.setFont(font)
        self.pm25_groupbox.setStyleSheet("")
        self.pm25_groupbox.setObjectName("pm25_groupbox")
        self.pm25_value = QtWidgets.QLabel(self.pm25_groupbox)
        self.pm25_value.setGeometry(QtCore.QRect(170, 50, 301, 111))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(48)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.visibility_groupbox.setTitle(_translate("MainWindow", "Visibility"))
        self.visibility_value.setText(_translate("MainWindow", "0 km"))
        self.pm25_groupbox.setTitle(_translate("MainWindow", "PM2.5"))
